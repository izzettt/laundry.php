            ...
            if (isset($_GET["id_transaksi"])) {
                ...
                <form action="process-transaksi.php" method="post">
                    ...
                    <form action="process-transaksi.php" method="post">
                        ...
                        <input type="hidden" name="id_usser"
                        value="<?=($_SESSION["usser"]["id_usser"])?>">
                        Admin
                        <input type="text" name="nama_usser" class="form-control mb-2"
                        value="<?=($_SESSION["usser"]["nama_usser"])?>" readonly>
